...
export default function NewProjectForm({ teamMembers }: { teamMembers: TeamMember[] }) {
      ...
      <form action={createProject} className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            className="bg-transparent border border-foreground/20 p-4 font-sans text-foreground focus:outline-none focus:border-primary transition-colors placeholder:text-foreground/10"
          />
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            name="content"
            rows={6}
            placeholder="Explain the process, the stack, and the outcome..."
            className="bg-transparent border border-foreground/20 p-4 font-sans text-foreground focus:outline-none focus:border-primary transition-colors placeholder:text-foreground/10"
          />
        </div>
