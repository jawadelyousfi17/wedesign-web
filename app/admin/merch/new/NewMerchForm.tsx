...
export default function NewMerchForm() {
  ...
  return (
    <div className="flex flex-col gap-12">
      ...
      <form action={createMerchItem} className="flex flex-col gap-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="flex flex-col gap-2">
            <label className="text-xs uppercase tracking-widest text-foreground/60 font-mono">Item Title</label>
            <input type="text" name="title" required value={title} onChange={handleTitleChange} placeholder="Brutalist Hoodie" className="bg-transparent border-b border-foreground/20 py-4 text-3xl font-serif text-foreground focus:outline-none focus:border-accent transition-colors" />
          </div>
          <div className="flex flex-col gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="flex flex-col gap-2">
            ...
            <input type="number" name="price" required placeholder="250" className="bg-transparent border-b border-foreground/20 py-4 text-xl font-mono text-foreground focus:outline-none focus:border-accent transition-colors" />
          </div>
          <div className="flex flex-col gap-2">
            <label className="text-xs uppercase tracking-widest text-foreground/60 font-mono">Category</label>
            <input type="text" name="category" placeholder="Clothing" className="bg-transparent border-b border-foreground/20 py-4 text-xl font-serif text-foreground focus:outline-none focus:border-accent transition-colors" />
          </div>
          <div className="flex items-center gap-4 py-4">
             <input type="checkbox" name="isActive" id="isActive" defaultChecked className="w-5 h-5 accent-foreground" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="flex flex-col gap-2">
            ...
            <input type="text" name="sizes" placeholder="S, M, L, XL" className="bg-transparent border-b border-foreground/20 py-4 font-mono text-foreground focus:outline-none focus:border-accent transition-colors" />
          </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea name="description" rows={3} className="bg-transparent border border-foreground/20 p-4 font-serif text-foreground focus:outline-none focus:border-accent transition-colors" />
        </div>
